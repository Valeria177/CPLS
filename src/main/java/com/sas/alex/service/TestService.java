    ...
    public Result getResults(Integer scores, Long id) {
        ...
        if (attempt.isFinished()) {
            ...
            if (scores <= 23) {
                ...
                //result1.setDescription("Ваш общий результат показывает, что у вас нет склонности к агрессии. Такие люли легко находят общий язык с разными людьми и редко выходят из себя.");
                //results.add(result1);
            } else if (scores <= 46) {
                ...
                //result2.setDescription("Ваш общий результат показывает, что у вас нет склонности к агрессии. Но иногда такие люди имеют настороженное и недоверчивое отношение к миру.");
                //results.add(result2);
            } else if (scores <= 69) {
